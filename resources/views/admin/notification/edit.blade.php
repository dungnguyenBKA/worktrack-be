                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <input class="form-control @error('title') is-invalid @enderror" type="text" name="title"
                               value="{{ old('title', $notification->title) }}" id="inputTitleId">
                        @error('title')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror"
                                  id="inputContentId" rows="5">{{ old('content', $notification->content) }}</textarea>
                        @error('content')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <span class="input-group-text">
                        ...
                        <input type="text" class="form-control date-time @error('start_time') is-invalid @enderror" id="inputStartTime"
                               ...
                               value="{{ old('start_time', \Carbon\Carbon::make($notification->start_time)->format('Y/m/d H:i')) }}" autocomplete="off">
                        @error('start_time')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
