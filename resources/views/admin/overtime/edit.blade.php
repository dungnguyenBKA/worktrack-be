...
<div class="container-fluid pb-3">
    ...
    <form class="card p-3 rounded-lg" method="POST" action="{{ route('overtimes.update', $overtime->id) }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10 input-group">
                ...
                <input type="text" class="form-control date-time @error('from_time') is-invalid @enderror" id="inputFromTime"
                       placeholder="yyyy/mm/dd --:--" name="from_time" autocomplete="off"
                       value="{{ get_datetime(old('from_time', $overtime->from_time), 'Y/m/d H:i') }}" >
                @error('from_time')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10 input-group">
                ...
                <input type="text" class="form-control date-time @error('to_time') is-invalid @enderror" id="inputToTime"
                       placeholder="yyyy/mm/dd --:--" name="to_time" autocomplete="off"
                       value="{{ get_datetime(old('to_time', $overtime->to_time), 'Y/m/d H:i') }}">
                @error('to_time')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('project') is-invalid @enderror" id="inputProject"
                       name="project" value="{{ old('project', $overtime->project) }}" >
                @error('project')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control @error('reason') is-invalid @enderror" id="inputReason" rows="3"
                          name="reason" >{{ old('reason', $overtime->reason) }}</textarea>
                @error('reason')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
                                ...
                                <td>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input @error('members') is-invalid @enderror" id="customCheck{{ $m->id }}"
                                               ...
                                               @if(in_array($m->id, !empty(old()) ? old('members', []) : $memberIds)) checked @endisset>
