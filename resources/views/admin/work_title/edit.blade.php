...
@section('content')
    <div class="container-fluid pb-3">
        ...
        <div class="card p-3 mb-3 rounded">
            <form method="POST" action="{{ route('work-titles.update', $workTitle->id) }}">
                @csrf
                @method('PUT')
                <input type="text" value="{{ $workTitle->id }}" name="id" hidden>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <input class="form-control @error('name_en') is-invalid @enderror" type="text" name="name_en"
                               value="{{ old('name_en', $workTitle->name_en) }}" id="inputStaffId">
                        @error('name_en')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <input class="form-control @error('name_vi') is-invalid @enderror" type="text" name="name_vi"
                               value="{{ old('name_vi', $workTitle->name_vi) }}" id="inputStaffId">
                        @error('name_vi')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <input class="form-control @error('name_ja') is-invalid @enderror" type="text" name="name_ja"
                               value="{{ old('name_ja', $workTitle->name_ja) }}" id="inputStaffId">
                        @error('name_ja')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
