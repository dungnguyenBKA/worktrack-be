...
@section('content')
    <div class="container-fluid pb-3">
        ...
        <div class="card p-3 mb-3 rounded">
            <form action="{{ route('national-day.update', $nationalDay->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        <input class="form-control @error('name') is-invalid @enderror" type="text" name="name"
                               value="{{ old('name', $nationalDay->name) }}" id="inputName">
                        @error('name')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        ...
                        <input class="form-control date @error('from_date') is-invalid @enderror" type="text" id="inputFromTime"
                               placeholder="yyyy/mm/dd" name="from_date" value="{{ old('from_date', $nationalDay->from_date) }}" autocomplete="off">
                        @error('from_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10 input-group">
                        ...
                        <input class="form-control date @error('to_date') is-invalid @enderror" type="text" id="inputEndTime"
                               placeholder="yyyy/mm/dd" name="to_date" value="{{ old('to_date', $nationalDay->to_date) }}" autocomplete="off">
                        @error('to_date')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="d-flex justify-content-end mb-2">
                    ...
                    <a class="btn btn-dark ml-2 btn-width-default" href="{{ route('national-day.index') }}">{{ __('layouts.close') }}</a>
                </div>
            </form>
        </div>
    </div>
